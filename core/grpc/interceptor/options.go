...
// LogRspPayload returns an Option that tells the OpenTracing instrumentation to
// try to log application payloads in both directions.
func LogRspPayload() Option {
	return func(o *options) {
		o.logRspPayload = true
	}
}

// LogReqParams allow log grpc request params to span log
func LogReqParams() Option {
	return func(o *options) {
		o.logReqParams = true
	}
}
